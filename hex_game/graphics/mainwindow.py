...
class Ui_TIPE(object):
    def setupUi(self, TIPE):
        ...
        self.label_3 = QtWidgets.QLabel(self.tabNewTraining)
        self.label_3.setObjectName("label_3")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_3)
        self.spinBoxBatchSize = QtWidgets.QSpinBox(self.tabNewTraining)
        self.spinBoxBatchSize.setMinimum(1)
        self.spinBoxBatchSize.setMaximum(999999999)
        self.spinBoxBatchSize.setSingleStep(10)
        self.spinBoxBatchSize.setProperty("value", 100)
        self.spinBoxBatchSize.setDisplayIntegerBase(10)
        self.spinBoxBatchSize.setObjectName("spinBoxBatchSize")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.spinBoxBatchSize)
